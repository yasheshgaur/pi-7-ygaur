...
public class Measurement extends TOP {
  ...
  /** getter for tn - gets stores the number of true negatives.
   * @generated
   * @return value of the feature 
   */
  public int getTn() {
    if (Measurement_Type.featOkTst && ((Measurement_Type)jcasType).casFeat_tn == null)
      jcasType.jcas.throwFeatMissing("tn", "type.Measurement");
    return jcasType.ll_cas.ll_getIntValue(addr, ((Measurement_Type)jcasType).casFeatCode_tn);}
    
  /** setter for tn - sets stores the number of true negatives. 
   * @generated
   * @param v value to set into the feature 
   */
  public void setTn(int v) {
    if (Measurement_Type.featOkTst && ((Measurement_Type)jcasType).casFeat_tn == null)
      jcasType.jcas.throwFeatMissing("tn", "type.Measurement");
    jcasType.ll_cas.ll_setIntValue(addr, ((Measurement_Type)jcasType).casFeatCode_tn, v);}    
  }
