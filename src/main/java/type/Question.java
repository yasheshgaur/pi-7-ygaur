...
public class Question extends ComponentAnnotation {
  ...
  */  
  ...
  public DoubleArray getWordVector() {
    if (Question_Type.featOkTst && ((Question_Type)jcasType).casFeat_WordVector == null)
      jcasType.jcas.throwFeatMissing("WordVector", "type.Question");
    return (DoubleArray)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Question_Type)jcasType).casFeatCode_WordVector)));}
  ...
  public void setWordVector(DoubleArray v) {
    if (Question_Type.featOkTst && ((Question_Type)jcasType).casFeat_WordVector == null)
      jcasType.jcas.throwFeatMissing("WordVector", "type.Question");
    jcasType.ll_cas.ll_setRefValue(addr, ((Question_Type)jcasType).casFeatCode_WordVector, jcasType.ll_cas.ll_getFSRef(v));}    
  ...
  public double getWordVector(int i) {
    if (Question_Type.featOkTst && ((Question_Type)jcasType).casFeat_WordVector == null)
      jcasType.jcas.throwFeatMissing("WordVector", "type.Question");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Question_Type)jcasType).casFeatCode_WordVector), i);
    return jcasType.ll_cas.ll_getDoubleArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Question_Type)jcasType).casFeatCode_WordVector), i);}
  ...
  public void setWordVector(int i, double v) { 
    if (Question_Type.featOkTst && ((Question_Type)jcasType).casFeat_WordVector == null)
      jcasType.jcas.throwFeatMissing("WordVector", "type.Question");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Question_Type)jcasType).casFeatCode_WordVector), i);
    jcasType.ll_cas.ll_setDoubleArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Question_Type)jcasType).casFeatCode_WordVector), i, v);}
  }
